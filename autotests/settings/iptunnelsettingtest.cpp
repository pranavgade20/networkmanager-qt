...
void IpTunnelSettingTest::testSetting()
{
    ...
    map.insert(QLatin1String(NMQT_SETTING_IP_TUNNEL_CONFIG_ENCAPSULATION_LIMIT), encapsulationLimit);
    map.insert(QLatin1String(NMQT_SETTING_IP_TUNNEL_CONFIG_FLAGS), flags);
    map.insert(QLatin1String(NMQT_SETTING_IP_TUNNEL_CONFIG_FLOW_LABEL), flowLabel);
    map.insert(QLatin1String(NMQT_SETTING_IP_TUNNEL_CONFIG_MTU), mtu);
    map.insert(QLatin1String(NMQT_SETTING_IP_TUNNEL_CONFIG_TOS), tos);
